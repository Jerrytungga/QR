...
if (isset($_POST['nip'])) {
  ...
  $sql = "SELECT * FROM traines WHERE nip='$nip'";
  $result = mysqli_query($conn, $sql);
  $sql1 = "SELECT * FROM asisten WHERE nip='$nip'";
  ...
  <div class="error-pagewrap">
    <div class="error-page-int">
      <div class="text-center m-b-md custom-login">
        <h3 style="color: #28A745;">PLEASE SCAN QR TO LOGIN APP</h3>
        <p>Pure Experience V1.0</p>
      </div>
      ...
      <div class="text-center login-footer">
        ...
        <a href="index.php" style="color: #28A745;">Back</a>
      </div>
    </div>
  </div>
