...
<body>
  ...
  <nav class="navbar navbar-light fixed-bottom" style="background-color: #28A745; ">
    ...
    <a class="navbar-brand text-light font-italic  font-weight-bold">Pure Experience <small><sup>V1.0</sup></small></a>
          ...
          <div class="modal-body " style="height: 300px;overflow: scroll;">
            <table class=" table table-striped">
              <tbody>
                ...
                $tampilan_presensi = mysqli_query($conn, "SELECT * FROM presensi where presensi_date='$hari_ini' group by nip order by presensi_time DESC");
