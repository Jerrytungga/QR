...
if (isset($_POST['update'])) {
    ...
    if ($foto != '') {
        if (move_uploaded_file($sumber, $target . $foto)) {
            $edit = mysqli_query($conn, "UPDATE `traines` SET `name`='$name',`foto`='$foto',`angkatan`='$batch',`alamat`='$address',`no_hp`='$phone',`lokalitas`='$lokal',`keterangan_tambahan`='$description',`gender`='$jenis_kelamin', `semester`='$semester' WHERE `nip`='$nip'");
    ...
    window.location.href='all_Trainess.php';
        ...
        $edit = mysqli_query($conn, "UPDATE `traines` SET `name`='$name',`angkatan`='$batch',`alamat`='$address',`no_hp`='$phone',`lokalitas`='$lokal',`keterangan_tambahan`='$description',`gender`='$jenis_kelamin' , `semester`='$semester'  WHERE `nip`='$nip'");
        echo ("<script LANGUAGE='JavaScript'>
    window.alert('Succesfully Updated');
    window.location.href='all_Trainess.php';
    </script>");
                                                    ...
                                                    <form action="" method="POST" enctype="multipart/form-data">
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <div class="form-group">
                                                                    <input name="address" type="text" class="form-control" value="<?= $datatranee['alamat']; ?>">
                                                                </div>
                                                                <div class="form-group">
                                                                    <input name="mobileno" type="number" class="form-control" value="<?= $datatranee['no_hp']; ?>">
                                                                </div>
                                                                <div class="form-group">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="form-group">
                                                                    <input name="lokalitas" type="text" class="form-control" value="<?= $datatranee['lokalitas']; ?>">
                                                                </div>
                                                                <div class="form-group res-mg-t-15">
                                                                    <textarea name="description"><?= $datatranee['keterangan_tambahan']; ?></textarea>
                                                                </div>
                                                                <div class="form-group">
